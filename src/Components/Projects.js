      ...
      <div className="projects-container">
        <div className="project-1">
          ...
          <div className="carousel">
            <a className="carousel-item"><img className="carousel-img"src={require("../Images/exempla/exempla-gif.gif")}></img></a>
      ...
      <hr className="horizontal-line" />
          ...
          {/*-------- Ourmask --------*/}
            ...
            <div className="project-card">
              <img className="project-image" src={require("../Images/ourmaskgif.gif")}/>
              <div className="card-info">
              <h1 className="card-title"> Ourmask.org</h1>
              <p className="card-description"> Share your homemade facemask designs. </p>
              <span className="card-links"> <a className="demo-link" href="url"> Website </a>
                <a className="github-link" href="url">Github</a>
              </span>
              </div>
            </div>
                      {/*-------- Ourmask --------*/}
            ...
            <div className="project-card">
              <img className="project-image" src={require("../Images/pipeline.jpg")}/>
              <div className="card-info">
              <h1 className="card-title"> Pipeline Portfolios</h1>
              <p className="card-description"> Real-time stock trading application. Robinhood, <i>basically. </i></p>
              <span className="card-links"> <a className="demo-link" href="url"> Website </a>
                <a className="github-link" href="url">Github</a>
              </span>
              </div>
            ...
            <div className="project-card">
              <img className="project-image" src={require("../Images/colorschemes.jpg")}/>
              <div className="card-info">
              <h1 className="card-title"> Color Palette Generator</h1>
              <p className="card-description"> Generate color schemes for your designs.</p>
              <span className="card-links"> <a className="demo-link" href="url"> Website </a>
                <a className="github-link" href="url">Github</a>
              </span>
              </div>
            ...
            <div className="project-card">
              <img className="project-image" src={require("../Images/bantergif.gif")}/>
              <div className="card-info">
              <h1 className="card-title"> Banter</h1>
              <p className="card-description">Adjust your share of the bill, including tip, in real time.</p>
              <span className="card-links"> <a className="demo-link" href="url"> Website </a>
                <a className="github-link" href="url">Github</a>
              </span>
              </div>
            ...
            <div className="project-card">
              <img className="project-image" src={require("../Images/artwork.jpg")}/>
              <div className="card-info">
              <h1 className="card-title"> Artwork</h1>
              <p className="card-description"> Connecting mural-needing businesses and with local artists</p>
              <span className="card-links"> <a className="demo-link" href="url"> Website </a>
                <a className="github-link" href="url">Github</a>
              </span>
              </div>
            ...
            <div className="project-card">
              <img className="project-image" src={require("../Images/maphunt.jpg")}/>
              <div className="card-info">
              <h1 className="card-title"> Maphunt</h1>
              <p className="card-description">Search for 4 random generated NYC landmarks using google street view.</p>
              <span className="card-links"> <a className="demo-link" href="url"> Website </a>
                <a className="github-link" href="url">Github</a>
              </span>
              </div>
